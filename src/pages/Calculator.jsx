...
export default function Calculator() {
  ...
  return (
    <>
      <SEO
        title="Tamil Nadu Engineering Cut Off Calculator 2026 — TNEA, TNAU, Paramedical"
        description="Calculate your Tamil Nadu cutoff marks for TNEA engineering, TNAU agriculture, TANUVAS veterinary, TNJFU fisheries, TNDALU law and paramedical courses. Enter your 12th marks and instantly view eligible courses."
